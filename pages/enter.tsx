...
const Enter: NextPage = (props) => {
  ...
  return (
    <div className='mt-16 px-4'>
      ...
      <div className='mt-12'>
        {data?.ok ? (
          <form onClick={tokenHandleSubmit(onTokenValid)} className='mt-8 flex flex-col space-y-4'>
            <Input
          ...
          <>
            ...
            <div className='flex flex-col items-center'>
              ...
              <div className='mt-8  grid  w-full grid-cols-2 border-b '>
                <button
                  className={cls("border-b-2 pb-4 text-sm font-medium", method === "email" ? " border-emerald-500 text-emerald-400" : "border-transparent text-gray-500 hover:text-gray-400")}
                  onClick={onEmailClick}>
                  Email
                </button>
                <button
                  className={cls("border-b-2 pb-4 text-sm font-medium", method === "phone" ? " border-emerald-500 text-emerald-400" : "border-transparent text-gray-500 hover:text-gray-400")}
