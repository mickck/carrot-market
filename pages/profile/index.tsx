        ...
        <div className='mt-10 flex justify-around'>
          <Link href='/profile/sold'>
            <a className='flex flex-col items-center'>
              ...
              <span className='mt-2 text-sm font-medium text-gray-700'>Sales history</span>
            </a>
          </Link>
          <Link href='/profile/bought'>
            <a className='flex flex-col items-center'>
              ...
              <span className='mt-2 text-sm font-medium text-gray-700'>Purchase history</span>
            </a>
          </Link>
          <Link href='/profile/loved'>
            <a className='flex flex-col items-center'>
              ...
              <span className='mt-2 text-sm font-medium text-gray-700'>Wishlist</span>
            </a>
          </Link>
        </div>
        <div className='mt-12'>
          <div className='flex items-center space-x-4'>
            ...
            <div>
              <h4 className='text-sm font-bold text-gray-800'>Maik</h4>
